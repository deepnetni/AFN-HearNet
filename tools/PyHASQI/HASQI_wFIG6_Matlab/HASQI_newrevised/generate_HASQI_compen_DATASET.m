...
train_data_path={'D:\JMCheng\DATASET\HASQI_fig6_DATASET\TEST_SET_new4',...
                 'D:\JMCheng\DATASET\HASQI_fig6_DATASET\TEST_SET_new4\test_clean',...
                 'D:\JMCheng\DATASET\HASQI_fig6_DATASET\TEST_SET_new4\test_clean_fig6',...
                 'D:\JMCheng\DATASET\HASQI_fig6_DATASET\TEST_SET_new4\test_mix',...
                 'D:\JMCheng\DATASET\HASQI_fig6_DATASET\TEST_SET_new4\test_mix_fig6'};
...
clean_path='F:\JMCheng\DATASET\100h_16k_DNS_noreverb_-5-15\test_clean_new';
noisy_dir_path={'F:\JMCheng\DATASET\100h_16k_DNS_noreverb_-5-15\test_mix_new'};
...
%                 g=squeeze(gainsTN(idx,:,:)); % 处理好的每一患耳对应的各声压级下各通道的增益
            ...
            if length(y_fig6)> 16000 * 6
                ...
                new_x_compen(1:length(y_fig6)) = x_fig6(1:16000 * 6);
                new_y(1:length(y_fig6)) = y(1:length(y_fig6));
                new_y_compen(1:length(y_fig6)) = y_fig6(1:16000 * 6);
            end
...
%                     fwrite(fid6,ht,'int32');
                ...
                for index=1:length(ht)
                     if index==length(ht)
                         fprintf(fid6,'%d\r\n',ht(index));
                     else
                         fprintf(fid6,'%d,',ht(index));
                     end
                end
