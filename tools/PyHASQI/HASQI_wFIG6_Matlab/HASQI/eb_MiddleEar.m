...
% through the cascade（串联） of filters. The middle ear model is a 2-pole 
% HP filter at 350 Hz（350Hz的2极点高通滤波器） in series with a 1-pole LP 
% filter at 5000 Hz（5000Hz的单极点低通滤波器）. The result is a rough 
% approximation to the equal-loudness contour at threshold.
%
% Calling variables:
%	x		input signal
...
% Design the 1-pole Butterworth LP using the bilinear transformation（双线性变换法）
